...
const { updateAvailable, version, isUpdating, downloadProgress, checkForUpdates, installUpdate } =
  useUpdater();
  ...
  <main class="h-relative h-screen w-screen p-0 bg-transparent overflow-hidden">
    ...
    >
      ...
      >
        ...
        <div class="w-full bg-slate-100 dark:bg-slate-700/60 rounded-full h-2.5 mb-2 overflow-hidden shadow-inner border border-slate-200 dark:border-slate-700/50">
          <div
        ...
        <div class="w-full flex justify-end">
          <span class="text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wide font-mono">
            {{ downloadProgress }}%
          </span>
        </div>
      </div>
