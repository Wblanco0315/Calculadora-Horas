...
const { updateAvailable, version, isUpdating, checkForUpdates, installUpdate } =
  useUpdater();
...
<template>
  <main class="h-relative h-screen w-screen p-0 bg-transparent overflow-hidden">
    ...
    >
      <div
        class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-2xl flex flex-col items-center"
      >
        <svg
