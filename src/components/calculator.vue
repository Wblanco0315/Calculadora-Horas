<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="flex justify-between items-end gap-2 mb-3">
          ...
          <button
            ...
            class="px-2 py-1 mb-1 text-xs font-medium text-blue-100 bg-blue-900/30 hover:bg-red-500 hover:text-white rounded flex items-center gap-1 transition-all"
      ...
      >
        <HoursForm
          :currentGoalMinutes="maxDailyMinutes"
          @add="addActivity"
          @update-goal="setMaxDailyMinutes"
        />
      </div>
      ...
      >
        <div v-if="activities.length === 0" class="text-center py-8 opacity-50">
          <svg
            xmlns="http://www.w3.org/2000/svg"
